...
class KLightStyle {
  ...
  static const dangerTextColor = Color.fromRGBO(255, 63, 75, 1);
  ...
  static const textFieldPlaceholderColor = Color.fromRGBO(25, 46, 81, 1);
  static const textFieldPlaceholderIconColor = Color.fromRGBO(25, 46, 81, 1);
  static const textFieldTextFontWeight = FontWeight.w500;
  static const textFieldTextSize = 11.0;

  static const listBackgroundColor = Color.fromRGBO(255, 255, 255, 1);
  static const lisAlternativeBackgroundColor = secondaryBackgroundColor;
}
